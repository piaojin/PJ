...
@interface PJCollectionViewLayout ()
@property (nonatomic, weak) id <PJCollectionViewLayoutDelegate> aDelegate;  //自动设置的代理
...
@implementation PJCollectionViewLayout
...
- (void)prepareLayout
{
    ...
    self.aDelegate = (id <PJCollectionViewLayoutDelegate> )self.collectionView.dataSource;
    ...
    for (NSInteger section = 0; section < numberOfSections; ++section)
    {
        ...
        if (headerHeight > 0)
        {
            attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:PJCollectionViewHeader withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
        ...
        if (footerHeight > 0)
        {
            attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:PJCollectionViewFooter withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];

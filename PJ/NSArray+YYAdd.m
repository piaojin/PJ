...
- (id)objectAtIndexSafe:(NSUInteger)index {
    if (index < self.count) {
        ...
        NSLog(@" crash ******* index %lu beyond bounds for  array:%@ ",(unsigned long)index ,self);
        return nil;
    }
...
- (void)removeObjectAtIndexSafe:(NSUInteger)index{
    ...
    if (index < self.count) {
        ...
        NSLog(@" crash ******* index %lu beyond bounds for  array:%@  count:%lu ",(unsigned long)index ,self,(unsigned long)self.count);
    }
